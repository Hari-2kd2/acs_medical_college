    ...
    public function findOvertimeSummaryReport($month)
    {
        ...
        foreach ($employees as $employee) {
            foreach ($data as $key => $value) {
                ...
                $result                        = DB::table('employee')->join('work_shift', "work_shift.work_shift_id", '=', 'employee.work_shift_id')->where('employee_id', $employee->employee_id)->select('start_time', 'end_time')->first();
