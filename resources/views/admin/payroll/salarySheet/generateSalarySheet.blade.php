                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="col-md-6"><b>{{ $employeeDetails->first_name }}
                                                        {{ $employeeDetails->last_name }}</b></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    {{ number_format(round($employeeTaxDeduction)) }}</td>
                                            </tr>
                                            ...
                                            @if ($employeeAllInfo['totalLateAmount'] != 0)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{ number_format($employeeAllInfo['totalLateAmount']) }}</td>
                                                    @php
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $employeeAllInfo['totalPresent'] }}
                                                </td>
                                            </tr>
                                            {{-- <tr> --}}
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"> {{ $employeeAllInfo['totalAbsence'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td> @lang('salary_sheet.per_day_salary') : </td>
                                                <td class="text-center">
                                                    {{ number_format($employeeAllInfo['oneDaysSalary']) }} </td>
                                            ...
                                            @if ($employeeAllInfo['dayOfSalaryDeduction'] != 0)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{ $employeeAllInfo['dayOfSalaryDeduction'] }} </td>
                                                </tr>
                                            @endif
                                            @if ($employeeAllInfo['totalOvertimeAmount'] != 0)
                                                <tr>
                                                    <td> @lang('salary_sheet.over_time') : </td>
                                                    <td class="text-center">
                                                        {{ $employeeAllInfo['totalOverTimeHour'] }} </td>
                                                </tr>
                                                <tr>
                                            ...
                                            @if (count($leaveRecords) > 0)
                                                @foreach ($leaveRecords as $leaveRecord)
                                                    <tr>
                                                        ...
                                                        <td class="text-center"> {{ $leaveRecord->number_of_day }}
                                                        </td>
